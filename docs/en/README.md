...
bannerBrand:
  ...
  tagline: Code records your growth, words share your knowledge
  buttons:
...
<!-- Personal info card - Click to pop up (template example, feel free to customize or remove) -->
<div class="profile-widget">
<!-- Bottom right trigger button -->
<div class="profile-trigger" id="profileTrigger">
<img src="/avatar.png" alt="Your avatar" style="border-radius: 8px;" />
...
<a href="mailto:your-email@example.com" class="social-link" title="Send Email">
<span class="social-icon">📧</span>
<span class="social-text">Email</span>
</a>
<a href="https://github.com/your-username" target="_blank" class="social-link" title="Visit GitHub">
<span class="social-icon">🐙</span>
...
<a href="https://github.com/your-username/your-repo" target="_blank" class="cta-btn primary">⭐ Star Support</a>
